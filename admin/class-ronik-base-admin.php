...
class Ronik_Base_Admin
{
	...
	public function add_media_cleaner_html_class($classes)
	{
		...
		if (is_admin() && (isset($_GET['page']) && $_GET['page'] === 'options-ronik-base_media_cleaner') || 
		(isset($_GET['page']) && $_GET['page'] === 'options-ronik-base_preserved') || 
		(isset($_GET['page']) && $_GET['page'] === 'options-ronik-base_support_media_cleaner') || 
		(isset($_GET['page']) && $_GET['page'] === 'options-ronik-base_media_cleaner_about') ||
		(isset($_GET['page']) && $_GET['page'] === 'options-ronik-base_integrations') ||
		(isset($_GET['page']) && $_GET['page'] === 'options-ronik-base_settings_media_cleaner')) {
	...
	public function rbp_plugin_dependencies()
	{
		...
		{
?><div class="error">
				<p>Sorry, but this Plugin requires the ACF plugin to be installed and active to work properly.</p>
			</div><?php
				}
			}
			...
			public function rmc_media_sync()
			{
				...
				$rbpHelper->ronikdesigns_write_log_devmode($transient_rmc_media_cleaner_media_data_collectors_image_id_array, 'low', 'rbp_media_cleaner');
				...
				$rbpHelper->ronikdesigns_write_log_devmode($rmc_media_cleaner_media_data_collectors_image_id_array_not_preserved, 'low', 'rbp_media_cleaner');
				...
				$rbpHelper->ronikdesigns_write_log_devmode($rmc_media_cleaner_media_data_collectors_image_thumbnail_auditor_array, 'low', 'rbp_media_cleaner');
				...
				$rbpHelper->ronikdesigns_write_log_devmode($rmc_media_cleaner_media_data_collectors_image_post_auditor_array, 'low', 'rbp_media_cleaner');
				...
				$rbpHelper->ronikdesigns_write_log_devmode($rmc_media_cleaner_media_data_collectors_image_post_content_auditor_array, 'low', 'rbp_media_cleaner');
				...
				$rbpHelper->ronikdesigns_write_log_devmode($rmc_media_cleaner_media_data_collectors_image_option_auditor_array, 'low', 'rbp_media_cleaner');
				...
				$rbpHelper->ronikdesigns_write_log_devmode($rmc_media_cleaner_media_data_collectors_image_filesystem_auditor_array, 'low', 'rbp_media_cleaner');
